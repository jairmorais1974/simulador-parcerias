              ...
              <div className="space-y-8">
                ...
                <div className="pt-8 border-t border-slate-100 space-y-8">
                  ...
                  <div className="pt-4 space-y-2">
                    <label className="text-xs font-bold text-slate-700 block">Regime Tributário do Dev</label>
                    <div className="grid grid-cols-2 gap-2 bg-slate-100 p-1 rounded-xl border border-slate-200">
                      <button
                        type="button"
                        onClick={() => set('regimeDev', 'lucro_presumido')}
                        className={`py-2 px-2 text-[11px] font-bold rounded-lg transition-all cursor-pointer text-center leading-tight ${
                          inputs.regimeDev === 'lucro_presumido'
